...
[Events1_with_pca, ~]             = addPCAAverageOldDataTestTwoOptions(  Events1, vClass1);   
[Events2_with_pca, ~]             = addPCAAverageOldDataTestTwoOptions(  Events2, vClass2);   
...
[pre1, pre2] = calPrecision(...
                                    c_data_for_classifier{1},...
                                    c_data_for_classifier{2},...
                                    vClass1                 ,...
                                    vClass2                  ...
                                 );
tmp_table_to_show = [tmp_table_to_show, num2str( pre1 ), num2str( pre2 )];
...
table_to_show = [table_to_show ; tmp_table_to_show];
disp(table_to_show); 
